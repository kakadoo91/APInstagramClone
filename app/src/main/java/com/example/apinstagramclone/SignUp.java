...
public class SignUp extends AppCompatActivity implements View.OnClickListener {
     ...
     private EditText edtName,edtPunchSpeed,edtPunchPwer,edtKickSpeed,edtKickPower;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPunchPwer = findViewById(R.id.edtPunchPower);
    ...
    public void onClick(View v) {
        try {
            ...
            kickBoxer.put("punchSpeed", Integer.parseInt(edtKickSpeed.getText().toString()));
